<template>
  <div>
    <a-modal :title="editId ? '编辑菜单': '创建菜单'" :visible="props.visible"
...
import {type imageIdSortList, type menuCreateRequest, type bannerType, menuUpdateApi} from "@/api/menu_api";
